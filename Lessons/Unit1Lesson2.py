# Predict: I predict that the code "print(24)" will output 24

# Run: My prediction was correct, outputting the 24

# Modify:
amount = 24
print("Two dozen is: ", amount)

# Using the variable amount can help with readability of the code and printing "Two dozen is: " helps with providing feedback and giving more information when running the code
